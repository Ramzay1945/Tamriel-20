...
## UltraPack Initialisation ##
	...
	def interfaceScreen (self):
		...
		# Help Text Area
		screen.setHelpTextArea( 350, FontTypes.SMALL_FONT, 7, yResolution - 302, -0.1, False, "", True, False, CvUtil.FONT_LEFT_JUSTIFY, 150 )
		...
		if iEra == 0:
			...
			screen.addDDSGFC( "InterfaceTopCenter", 'Art/Interface/Screens/RenIndu/MainHud_TC.tga', 257, -2, xResolution, 60, WidgetTypes.WIDGET_GENERAL, -1, -1 )
	...
	def updateGameDataStrings( self ):
		...
		if ( CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_MINIMAP_ONLY  and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_ADVANCED_START):
			...
			if (gc.getPlayer(ePlayer).isAlive()):
				...
				screen.setLabel( "GoldText", "Background", szText, CvUtil.FONT_LEFT_JUSTIFY, 62, 6, 0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
	...
	def updateCityScreen( self ):
		...
		if ( CyInterface().isCityScreenUp() ):
			if ( pHeadSelectedCity ):
				...
				screen.setLabel( "NationalityText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, 125, yResolution - 250, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
