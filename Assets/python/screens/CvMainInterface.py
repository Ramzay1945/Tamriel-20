...
## UltraPack Initialisation ##
	...
	def interfaceScreen (self):
		...
		iEra = gc.getPlayer(gc.getGame().getActivePlayer()).getCurrentEra()

		# Help Text Area
		screen.setHelpTextArea( 350, FontTypes.GAME_FONT, 7, yResolution - 302, -0.1, False, "", True, False, CvUtil.FONT_LEFT_JUSTIFY, 150 )
		...
		#City Screen: Research/Gold/Culture Levels
		screen.addPanel( "CityScreenAdjustPanel", u"", u"", True, False, 10, 65, 238, 105, PanelStyles.PANEL_STYLE_STANDARD )
		screen.setStyle( "CityScreenAdjustPanel", "Panel_City_Info_Style" )
		screen.hide( "CityScreenAdjustPanel" )
		
		#City Screen: Growth & Production Progress Bar Backgrounds, Left & Right Halves
		...
		# Left Background Widget		(Main Screen: Highlight behind name of unit & Picture)
		...
		if iEra == 0:
			screen.addDDSGFC( "InterfaceTopLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_C.tga', 258, 0, xResolution - 516, 189, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_L.tga', 0, 0, 308, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterRightBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_R.tga', xResolution - 298, 0, 298, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "CityScreenTopWidget", 'Art/Interface/Screens/RenIndu/CityHud_T.tga', 0, -2, xResolution, 41, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "CityNameBackground", 'Art/Interface/Screens/RenIndu/CityTitle.tga', 0, 22, xResolution, 55, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BC.tga', 296, yResolution - 153, xResolution - (296*2), 153, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BL.tga', 0, yResolution - 324, 324, 324, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceRightBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BR.tga', xResolution - 324, yResolution - 188, 324, 188, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopCenter", 'Art/Interface/Screens/RenIndu/MainHud_TC.tga', 0, -18, 1650, 93, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopLeft", 'Art/Interface/Screens/RenIndu/MainHud_TL.tga', 0, -2, 317, 80, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopRight", 'Art/Interface/Screens/RenIndu/MainHud_TR.tga', xResolution - 447, -2, 447, 110, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		elif iEra < 5:
			screen.addDDSGFC( "InterfaceTopLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_C.tga', 258, 0, xResolution - 516, 189, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_L.tga', 0, 0, 308, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterRightBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_R.tga', xResolution - 298, 0, 298, yResolution-149, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "CityScreenTopWidget", 'Art/Interface/Screens/RenIndu/CityHud_T.tga', 0, -2, xResolution, 41, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "CityNameBackground", 'Art/Interface/Screens/RenIndu/CityTitle.tga', 260, 31, xResolution - (260*2), 38, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceCenterBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BC.tga', 296, yResolution - 153, xResolution - (296*2), 153, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BL.tga', 0, yResolution - 324, 324, 324, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceRightBackgroundWidget", 'Art/Interface/Screens/RenIndu/MainHud_BR.tga', xResolution - 324, yResolution - 188, 324, 188, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopCenter", 'Art/Interface/Screens/RenIndu/MainHud_TC.tga', 257, -2, xResolution-(247*2), 60, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopLeft", 'Art/Interface/Screens/RenIndu/MainHud_TL.tga', 0, -2, 317, 80, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.addDDSGFC( "InterfaceTopRight", 'Art/Interface/Screens/RenIndu/MainHud_TR.tga', xResolution - 447, -2, 447, 110, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		elif iEra == 5:
			screen.addDDSGFC( "InterfaceTopLeftBackgroundWidget", 'Art/Interface/Screens/RenIndu/CityHud_C.tga', 258, 0, xResolution - 516, 189, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		...
		# Turn log Button
		screen.setImageButton( "TurnLogButton", "", iBtnX - 12, iBtnY - 20, iBtnWidth, iBtnWidth, WidgetTypes.WIDGET_ACTION, gc.getControlInfo(ControlTypes.CONTROL_TURN_LOG).getActionInfoIndex(), -1 )
		screen.setStyle( "TurnLogButton", "Button_HUDLog_Style" )
		screen.hide( "TurnLogButton" )
		
		iBtnY = 48
		iBtnX = xResolution - 430 #277
		...
		screen.setImageButton( "InterfaceHelpButton", ArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_CIVILOPEDIA_ICON").getPath(), xResolution - 40, 2, 36, 36, WidgetTypes.WIDGET_ACTION, gc.getControlInfo(ControlTypes.CONTROL_CIVILOPEDIA).getActionInfoIndex(), -1 )
		screen.hide( "InterfaceHelpButton" )

		screen.setImageButton( "MainMenuButton", ArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_MENU_ICON").getPath(), xResolution - 80, 2, 36, 36, WidgetTypes.WIDGET_MENU_ICON, -1, -1 )
		screen.hide( "MainMenuButton" )

		# Globeview buttons
		self.createGlobeviewButtons( )

		screen.addMultiListControlGFC( "BottomButtonContainer", "", iMultiListXL, yResolution - 113, xResolution - (iMultiListXL+iMultiListXR), 100, 4, 48, 48, TableStyles.TABLE_STYLE_STANDARD )		
		...
		screen.addStackedBarGFC( "CultureBar", 16, yResolution - 228, 220, iStackBarHeight, InfoBarTypes.NUM_INFOBAR_TYPES, WidgetTypes.WIDGET_HELP_CULTURE, -1, -1 )
		...
		screen.hide( "CultureBar" )
                ...
                # Removed infavor of adding the Holy City Overlay when
                # the Religion Icons are added to the screen
		# Holy City Overlay
		#for i in range( gc.getNumReligionInfos() ):
			...
			#screen.hide( szName )
                ...
                # < 47 Religions Mod Start >
                # Removed infavor of adding the Headquarters Overlays when
                # the Corporation Icons are added to the screen
		...
		screen.addStackedBarGFC( "NationalityBar", 16, yResolution - 254, 220, iStackBarHeight, InfoBarTypes.NUM_INFOBAR_TYPES, WidgetTypes.WIDGET_HELP_NATIONALITY, -1, -1 )
		...
		screen.setLabel( "TradeRouteListLabel", "Background", localText.getText("TXT_KEY_HEADING_TRADEROUTE_LIST", ()), CvUtil.FONT_CENTER_JUSTIFY, 129, 165, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		...
		screen.setLabel( "BuildingListLabel", "Background", localText.getText("TXT_KEY_CONCEPT_BUILDINGS", ()), CvUtil.FONT_CENTER_JUSTIFY, 129, 295, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		...
		for i in range( gc.getMAX_PLAYERS() ):
			...
			screen.setText( szName, "Background", u"", CvUtil.FONT_RIGHT_JUSTIFY, 996, 622, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_CONTACT_CIV, i, -1 )
			screen.hide( szName )
	...
	def updateScreen(self):
		...
		if (CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_ADVANCED_START):
			self.updateTimeText()
			screen.setLabel( "TimeText", "Background", g_szTimeText, CvUtil.FONT_RIGHT_JUSTIFY, xResolution - 90, 6, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
	...
	def updatePlotListButtons( self ):
		...
		if ( CyInterface().shouldDisplayUnitModel() and CyEngine().isGlobeviewUp() == false and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL ):
			if ( CyInterface().isCitySelection() ):
				...
				screen.addSpecificUnitGraphicGFC( "InterfaceUnitModel", CyInterface().getHeadSelectedUnit(), 15, yResolution - 288, 163, 172, WidgetTypes.WIDGET_UNIT_MODEL, CyInterface().getHeadSelectedUnit().getUnitType(), -1,  -20, 30, 1, False )
	...
	def updateSelectionButtons( self ):
		...
		if (not CyEngine().isGlobeviewUp() and pHeadSelectedCity):
			...
			if ((pHeadSelectedCity.getOwner() == gc.getGame().getActivePlayer()) or gc.getGame().isDebugMode()):
				...
				screen.setButtonGFC( "Conscript", szText, "", iBtnX + 1, iBtnY, iBtnW, iBtnH, WidgetTypes.WIDGET_CONSCRIPT, -1, -1, ButtonStyles.BUTTON_STYLE_STANDARD )
				...
				# Hurry Buttons		
				screen.setButtonGFC( "Hurry0", "", "", iBtnX + 4, iBtnY, iBtnW, iBtnH, WidgetTypes.WIDGET_HURRY, 0, -1, ButtonStyles.BUTTON_STYLE_STANDARD )
				...
				screen.addCheckBoxGFC( "AutomateProduction", "", "", iBtnX + 4, iBtnY, iBtnW, iBtnH, WidgetTypes.WIDGET_AUTOMATE_PRODUCTION, -1, -1, ButtonStyles.BUTTON_STYLE_STANDARD )
	...
	def updateGameDataStrings( self ):
		...
		if ( CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_MINIMAP_ONLY  and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_ADVANCED_START):
			...
			if (gc.getPlayer(ePlayer).isAlive()):
				...
				for iI in range( CommerceTypes.NUM_COMMERCE_TYPES ):
					...
					if (gc.getPlayer(ePlayer).isCommerceFlexible(eCommerce) or (CyInterface().isCityScreenUp() and (eCommerce == CommerceTypes.COMMERCE_GOLD))):
						...
						szString = "PercentText" + str(iI)
						screen.setLabel( szString, "Background", szOutText, CvUtil.FONT_LEFT_JUSTIFY, 14, 50 + (iCount * 19), -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
						screen.show( szString )
						...
						if not CyInterface().isCityScreenUp():
							...
							szString = "RateText" + str(iI)
							screen.setLabel( szString, "Background", szOutText, CvUtil.FONT_LEFT_JUSTIFY, 112, 50 + (iCount * 19), -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
							screen.show( szString )
			...
			if (gc.getPlayer(ePlayer).isAlive()):
				...
				screen.setLabel( "GoldText", "Background", szText, CvUtil.FONT_LEFT_JUSTIFY, 62, 6, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 ) #иконка с золотом левый верхний угол
	...
	def updateCityScreen( self ):
		...
		if ( CyInterface().isCityScreenUp() ):
			if ( pHeadSelectedCity ):
				...
				# Help Text Area
				screen.setHelpTextArea( 390, FontTypes.GAME_FONT, 0, 0, -2.2, True, ArtFileMgr.getInterfaceArtInfo("POPUPS_BACKGROUND_TRANSPARENT").getPath(), True, True, CvUtil.FONT_LEFT_JUSTIFY, 0 )
				...
				for i in range(CommerceTypes.NUM_COMMERCE_TYPES):
					...
					if ((gc.getPlayer(pHeadSelectedCity.getOwner()).isCommerceFlexible(eCommerce)) or (eCommerce == CommerceTypes.COMMERCE_GOLD)):
						...
						screen.setLabel( szName, "Background", szBuffer, CvUtil.FONT_RIGHT_JUSTIFY, 220, 45 + (19 * iCount) + 4, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_COMMERCE_MOD_HELP, eCommerce, -1 )
						screen.show( szName )
						iCount = iCount + 1
				...
				screen.addTableControlGFC( "BuildingListTable", 3, 10, 317, 238, yResolution - 601, False, False, 32, 32, TableStyles.TABLE_STYLE_STANDARD )
				...
				for i in range( gc.getNumBonusInfos() ):
					...
					if ( pHeadSelectedCity.hasBonus(i) ):
						...
						if (iHappiness != 0):
							...
							screen.setLabelAt( szName, "BonusBack2", szLeadBuffer, CvUtil.FONT_LEFT_JUSTIFY, 0, (iRightCount * 20) + 4, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS, i, -1 )
							szName = "RightBonusItemRight" + str(iRightCount)
							screen.setLabelAt( szName, "BonusBack2", szTempBuffer, CvUtil.FONT_RIGHT_JUSTIFY, 102, (iRightCount * 20) + 4, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS, i, -1 )
						...
						if (iHealth != 0 and bHandled == False):
							...
							screen.setLabelAt( szName, "BonusBack1", szLeadBuffer, CvUtil.FONT_LEFT_JUSTIFY, 0, (iCenterCount * 20) + 4, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS, i, -1 )
							szName = "CenterBonusItemRight" + str(iCenterCount)
							screen.setLabelAt( szName, "BonusBack1", szTempBuffer, CvUtil.FONT_RIGHT_JUSTIFY, 62, (iCenterCount * 20) + 4, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS, i, -1 )
						...
						if ( not bHandled ):
							...
							screen.setLabelAt( szName, "BonusBack0", szLeadBuffer, CvUtil.FONT_LEFT_JUSTIFY, 0, (iLeftCount * 20) + 4, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS, i, -1 )
				...
				screen.setLabel( "MaintenanceText", "Background", szBuffer, CvUtil.FONT_LEFT_JUSTIFY, 15, 126, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_HELP_MAINTENANCE, -1, -1 )
				...
				screen.setLabel( "MaintenanceAmountText", "Background", szBuffer, CvUtil.FONT_RIGHT_JUSTIFY, 220, 125, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_HELP_MAINTENANCE, -1, -1 )
				...
				screen.setLabel( "NationalityText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, 125, yResolution - 250, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
				...
				if (iDefenseModifier != 0):
					...
					screen.setLabel( "DefenseText", "Background", szBuffer, CvUtil.FONT_RIGHT_JUSTIFY, xResolution - 270, 40, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_HELP_DEFENSE, -1, -1 )
				...
				if ( pHeadSelectedCity.getCultureLevel != CultureLevelTypes.NO_CULTURELEVEL ):
					...
					screen.setLabel( "CultureText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, 125, yResolution - 224, -1.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			...
			if ( CyInterface().getShowInterface() == InterfaceVisibility.INTERFACE_SHOW ):
				...
				screen.setHelpTextArea( 350, FontTypes.GAME_FONT, 7, yResolution - 50, -0.1, False, "", True, False, CvUtil.FONT_LEFT_JUSTIFY, 150 )
	...
	def updateInfoPaneStrings( self ):
		...
		if (pHeadSelectedCity):
			...
			if (CyInterface().getLengthSelectionList() > 1):
				...
				screen.setText( "SelectedUnitLabel", "Background", localText.getText("TXT_KEY_UNIT_STACK", (CyInterface().getLengthSelectionList(), )), CvUtil.FONT_LEFT_JUSTIFY, 18, yResolution - 137, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_UNIT_NAME, -1, -1 )
				...
				screen.setText( "SelectedUnitLabel", "Background", szBuffer, CvUtil.FONT_LEFT_JUSTIFY, 18, yResolution - 137, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_UNIT_NAME, -1, -1 )
							...
							if (not CyInterface().isScoresMinimized() or gc.getGame().getActivePlayer() == ePlayer):
								if (gc.getPlayer(ePlayer).isAlive() and not gc.getPlayer(ePlayer).isMinorCiv()):
									...
									if (gc.getPlayer(ePlayer).getTeam() == eTeam):
										...
										screen.setText( szName, "Background", szBuffer, CvUtil.FONT_RIGHT_JUSTIFY, xResolution - 12, yCoord - (iCount * iBtnHeight), -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_CONTACT_CIV, ePlayer, -1 )
										screen.show( szName )
	...
	def updateScoreStrings( self ):
		...
		screen.addTableControlGFC("ScoreForeground", 5, xResolution - self.iScoreWidth - 150 - iLeaderNameWidth, yResolution - iHeight - 180, self.iScoreWidth + 180 + iLeaderNameWidth, iHeight, False, False, 30, 30, TableStyles.TABLE_STYLE_STANDARD)
		...
		screen.setTableColumnHeader("ScoreForeground", 2, "", 30)
		screen.setTableColumnHeader("ScoreForeground", 3, "", 30)
		...
		for iPlayer in lPlayers:
			...
			"""
			sLName = u"<color=%d,%d,%d,%d>%s</color>" %(pPlayer.getPlayerTextColorR(), pPlayer.getPlayerTextColorG(), pPlayer.getPlayerTextColorB(), pPlayer.getPlayerTextColorA(), pPlayer.getCivilizationShortDescription(0)) + u"</font>"
		...
		if kEngine.isGlobeviewUp() and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL:
			...
			if bHasOptions:
				...
				for iTmp in range(iNumOptions):
					...
					screen.setText( szName, "Background", szBuffer, CvUtil.FONT_LEFT_JUSTIFY, xResolution - 9 - iTextWidth, iCurY-iGlobeLayerOptionHeight-10, -0.3, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GLOBELAYER_OPTION, iOption, -1 )
					screen.show( szName )
